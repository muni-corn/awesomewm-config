...
-- Create the buttons
local poweroff = create_button(poweroff_text_icon, colors.color1, "Poweroff", poweroff_command)
local reboot = create_button(reboot_text_icon, colors.color2, "Reboot", reboot_command)
local suspend = create_button(suspend_text_icon, colors.color3, "Suspend", suspend_command)
local exit = create_button(exit_text_icon, colors.color4, "Exit", exit_command)
